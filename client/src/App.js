  ...
  render() {
    return (
      <div className="App">
        ...
        <div id="login">
          <input type="text" name="email" onChange={(e) => this.handleChangeLogin(e)} />   <br /> <span id="login-error-email" className="error"> </span>  <br />
          <input type="text" name="password" onChange={(e) => this.handleChangeLogin(e)} />   <br /> <span id="login-error-password" className="error"></span> <br />
